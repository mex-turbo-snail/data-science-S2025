...
- Document your observations here.
  - Based on the visual, I can see that the families that end up on the lower side of the median household income are 2 person families. I find it interesting however that most of the other sized families vary in terms of range depending on county. As an example of this, we can see that in Nantucket, there is a really wide range of median household income when it comes to 5 person families, but when it comes to 5 person families in Bristol for example, that range it extremely low. I makes you think on why ity might be this way, but also gives you the information on which counties might be struggling the most in terms of median household income, and with this information, the opportunity to help those who need it.
  
- Can you confidently distinguish between household incomes in Suffolk county? Why or why not?
  - No, I say this because in Suffolk in particular, the household income ranges are so small that it becomes difficult to differentiate one another. 
...
- What *overall* trend do you see between `SE` and population? Why might this trend exist?
  - Overall, as population estimates go down the standard error for income rises, but at the smae time higher families tend to rise more.
- What does this *overall* trend tell you about the relative ease of studying small vs large counties?
  - This trend essentially tells us that it is easier to study larger counties as it offers less standard error. This can be shown as we go down in numbers of population, the chance of getting higher numbers in error becomes more likely. 
...
- Here I have a scatter plot showing the relationship between the population estimate and income estimates in New York (where I am original from). All counties are included but, I highlighted the Bronx, Queens and Manhattan (Which is often refereed to as New York). Initially, I found interesting was that even though Queens has the higher population out of the 3, Manhattan still has the higher income. After some thought, this made sense because more people commute to work in Manhattan and choose to live in other boroughs like Queens or The Bronx because of the price of living in Manhattan (Due to the limited estate). Overall I thought this was interesting to look at and wonder what other things may be affecting this.
