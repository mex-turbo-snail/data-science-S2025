...
- What last name is most prevalent in `df_sample_seq`?
  ...
  - The last name that was the most prevalent was “Sorensen”.

- Is this sample representative of *all* houses in Helvig? Why or why
  not?

  - I so not believe that this is representative of all of the houses of
    Helvig, especially because the house number only goes to 25, and
    there are way more houses than that in Helvig.
...
- Which sample—sequential or random—is more *representative* of all
  ...
  - Id say that the Random sample is more representative of all of the
    homes in Helvig because it Incorporated a wider variety of
    information, essentially removing biases within data collection and
    gives the opportunity to have more of a general sample, this making
    it more likely that we get a more diverse set of data that still
    represents the homes in Helvig.
...
- Is there any reason that people with the same last name might tend to
  *live near each other*?
  ...
  - It is likely that family members or relatives would want to live
    closer to each other, which would explain how in the sequential
    sample(where we can assume people are living next to each other in
    that order) , the most prevalent last name was “Sorensen” and in the
    random sample “Sorensen” turned out not to be the most prevalent
    last name.
...
```
    ...
    ## 1 prevalence 0.0345     0.105  0.193   0.05 percentile
...
- What is highest possible prevalence for your chosen name, based on the
  ...
  - After conducting the Bootstrap Confident Interval, It turns out that
    with “Collins” as the lat name, the highest possible prevalencewas
    0.1929825.
...
- Note that we used the *random* sample with the bootstrap procedure in
  ...
  - (Yes or no.) NO
  - I belive that taking the Bootstrap confidance interval of the
    sequntial sample will not be representative of all of Helvig because
    we already determined that the sequntial sample likely includes bias
    in the sense that, in sqential order, people of the same lastname
    are more likely to live next to each other.
...
The website was down when we were doing this

#### Population

- (What population are you going to study?)
  - We are planning to take a random sample of the population of Akkeshi

#### Quantity of interest

- Our quantity of interest will be reaction time

#### Covariates

- Alcohol Consumption
- Other consumption of drugs
...
- This would be experimental because we are going to record their
  reaction time before and then provide them with substances and them
  their reaction time afterwards.
